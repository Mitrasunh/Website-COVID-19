                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                                    ...
                                    <li class="nav-item">
                                         <a class="nav-link" id="pills-peta_sebaran-tab" data-toggle="pill" href="#pills-peta_sebaran" role="tab" aria-controls="pills-peta_sebaran" aria-selected="false">Peta Sebaran</a>
                                    </li>
                                </ul>
        ...
        <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
            <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                 ...
                 <div class="tab-pane fade" id="pills-peta_sebaran" role="tabpanel" aria-labelledby="pills-peta_sebaran-tab">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <h4 class="header-title">Peta Sebaran Covid-19 Kota Pematangsiantar</h4>
                                <div class="table-responsive">
                                    <table align = "left"class="table table-hover progress-table text-center" >
                                        <thead class="text-capitalize">
                                            <tr>
                                                <th>No</th>
                                                <th width='60%'>Peta Sebaran</th>
                                                <th>Waktu Unggah</th> 
                                                <th>Aksi</th>
                                            </tr>
                        	            </thead>
                                        <tbody>
                                            <?php
                                                include 'database_gambar.php';
                                                $sql="select * from petasebaran order by id_gambar desc limit 10";
                                                $hasil=mysqli_query($kon,$sql);
                                                $no=0;
                                                //Menampilkan data dengan perulangan while
                                                while ($data = mysqli_fetch_array($hasil)):
                                            ...
                                            <tr>
                                                <td><?php echo $no; ?></td>
                                                <td><img src="gambar/<?php echo $data['gambar'];?>" class="rounded" width='100%' alt="Gambar Peta Sebaran"></td>
                                                <td><?php echo $data['datetime']; ?></td>
                                                <td><a href="hapus_petasebaran.php?id_gambar=<?php echo $data['id_gambar'];?>&gambar=<?php echo $data['gambar'];?>" onclick="konfirmasi()" class="btn btn-danger" role="button">Hapus</a></td>
                                            </tr>
                                            <!-- bagian akhir (penutup) while -->
                                            <?php endwhile; ?>
			                            </tbody>
						            </table>
							           <button type="button" class="btn btn-success btn-md mb-3"><a href="datavaksin_petasebaran.php">Unggah Peta Sebaran(.jpg)</button></a>
                                </div>
                        </div>
                    </div>
                </div>
