   ...
   <nav class="navbar navbar-inverse">
    <div class="container-fluid">
     <div class="navbar-header">
      <h2 class="navbar-brand">Halaman Upload File Peta Sebaran (IMAGE)</h2>
    </div>
  </div>
  </nav>
    <br>
    <div class="container">
        ...
        ?>
        <form action="simpan_petasebaran.php" method="post" enctype="multipart/form-data">
            <!-- rows -->   
            <div class="row">
                <div class="col-sm-6">
                    <div class="form-group">
                        ...
                        <input type="file" name="gambar" class="file" >
                            <div class="input-group my-3">
                                <input type="text" class="form-control" disabled placeholder="Upload peta sebaran (Image)" id="file">  
            ...
            <div class="col-sm-6">
                <div class="table-responsive">
                    ...
                    <table class="table table-bordered" width='20%'cellspacing="0">
                        ...
                        <h5><center>Peta sebaran (Image) <?php echo $data['datetime'];?></center> </h5>
                    </table>
                </div>
            </div>
        </div>
