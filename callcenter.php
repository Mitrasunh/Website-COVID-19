                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item ">
                                ...
                                <div id="submenu-4" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link active" href="callcenter.php">Call Center Dinas Kesehatan Kota Pematangsiantar</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h3 class="mb-2">Call Center Dinas Kesehatan Kota Pematangsiantar </h3>
                                <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Kontak Penting</a></li>
                                            <li class="breadcrumb-item active" aria-current="page">Call Center Dinas Kesehatan Kota Pematangsiantar</li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form>
                                        <input class="form-control form-control-lg" type="search" placeholder="Cari Data Call Center" aria-label="Search">
                                                ...
                                                <div class="pl-xl-3">
                                                    <div class="m-b-0">
                                                        <div class="user-avatar-name d-inline-block">
                                                            <h2 class="font-24 m-b-10">dr. Erika Silitonga (0812-6000-4795)</h2>
                                                        </div>
                                                    </div>
                                                    <div class="user-avatar-address">
                                                        <p class="mb-2"><i class="fa fa-map-marker-alt mr-2  text-primary"></i>Dinas Kesehatan Kota Pematangsiantar
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="user-avatar float-xl-left pr-4 float-none">
                                                ...
                                                <div class="pl-xl-3">
                                                    <div class="m-b-0">
                                                        <div class="user-avatar-name d-inline-block">
                                                            <h2 class="font-24 m-b-10">dr. Meiland, Sp.P (0813-6152-7822)</h2>
                                                        </div>
                                                    </div>
                                                    <div class="user-avatar-address">
                                                        <p class="mb-2"><i class="fa fa-map-marker-alt mr-2  text-primary"></i>Dinas Kesehatan Kota Pematangsiantar
                                            ...
                                            <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="float-xl-right float-none mt-xl-0 mt-4">
                                                    <a href="tel:+6281261527822" class="btn btn-primary">Panggilan Telepon</a>
                                                </div><br><br>
                                                <div class="float-xl-right float-none mt-xl-0 mt-4">
                                                    <a href="https://wa.me/6281261527822" class="btn btn-success">Pesan Whatsapp</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="user-avatar float-xl-left pr-4 float-none">
                                                ...
                                                <div class="pl-xl-3">
                                                    <div class="m-b-0">
                                                        <div class="user-avatar-name d-inline-block">
                                                            <h2 class="font-24 m-b-10">Misran (0812-6300-971)</h2>
                                                        </div>
                                                    </div>
                                                    <div class="user-avatar-address">
                                                        <p class="mb-2"><i class="fa fa-map-marker-alt mr-2  text-primary"></i>Dinas Kesehatan Kota Pematangsiantar
                                            ...
                                            <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="float-xl-right float-none mt-xl-0 mt-4">
                                                    ...
                                                    <a href="tel:+628126300971" class="btn btn-primary">Panggilan Telepon</a>
                                                </div><br><br>
                                                <div class="float-xl-right float-none mt-xl-0 mt-4">

                                                    <a href="https://wa.me/628126300971" class="btn btn-success">Pesan Whatsapp</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-xl-9 col-lg-12 col-md-12 col-sm-12 col-12">
                                            <div class="user-avatar float-xl-left pr-4 float-none">
                                                ...
                                                <div class="pl-xl-3">
                                                    <div class="m-b-0">
                                                        <div class="user-avatar-name d-inline-block">
                                                            <h2 class="font-24 m-b-10"> Mei Arina Sinaga (0822-1669-8340)</h2>
                                                        </div>
                                                    </div>
                                                    <div class="user-avatar-address">
                                                        <p class="mb-2"><i class="fa fa-map-marker-alt mr-2  text-primary"></i>Dinas Kesehatan Kota Pematangsiantar
                                            ...
                                            <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="float-xl-right float-none mt-xl-0 mt-4">
                                                    ...
                                                    <a href="tel:+6282216698340" class="btn btn-primary">Panggilan Telepon</a>
                                                </div><br><br>
                                                <div class="float-xl-right float-none mt-xl-0 mt-4">

                                                    <a href="https://wa.me/6282216698340" class="btn btn-success">Pesan Whatsapp</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
