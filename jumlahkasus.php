                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                    <li class="nav-item">
                                            <a class="nav-link active" href="jumlahkasus.php">jumlah Kasus Covid-19 Kota Pematangsiantar</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="page-header">
                                <h2 class="pageheader-title">Jumlah Kasus Covid-19 Kota Pematangsiantar </h2>
                                <p class="pageheader-text">Proin placerat ante duiullam scelerisque a velit ac porta, fusce sit amet vestibulum mi. Morbi lobortis pulvinar quam.</p>
                                <div class="page-breadcrumb">
                                    <nav aria-label="breadcrumb">
                                        <ol class="breadcrumb">
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Data</a></li>
                                            <li class="breadcrumb-item"><a href="#" class="breadcrumb-link">Jumlah Kasus Covid-19 Kota Pematangsiantar</a></li>
                                        </ol>
                                    </nav>
                                </div>
                            </div>
